...
<?php 
  ...
  <div class="container px-5 my-5">
    <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="./xulysuakhenthuong.php" method="post">
        ...
        <div class="mb-3">
            <label class="form-label" for="newField9">Tên khen thưởng</label>
            <input class="form-control" id="newField9" type="text" placeholder="" data-sb-validations="required" name="txt_tkt" value="<?php echo $ten ?>" />
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="newField12" type="text" placeholder="" data-sb-validations="required" name="txt_lkt" value="<?php echo $lkt ?>" />
            <div class="invalid-feedback" data-sb-feedback="newField12:required">Loại khen thưởng không được để trống.</div>
        </div>
        <div class="mb-3">
            <label class="form-label" for="newField12">Tên học kì</label>
            <input class="form-control" id="newField12" type="text" placeholder="" data-sb-validations="required" name="txt_thk" value="<?php echo $thk ?>" />
            <div class="invalid-feedback" data-sb-feedback="newField12:required">Mã học kì không được để trống.</div>
        </div>
        <div class="d-grid">
            <button class="btn btn-primary" id="submitButton" type="submit" name="suakhenthuong">sửa</button>
        </div>
    </form>
</div>
  <!---end---->
