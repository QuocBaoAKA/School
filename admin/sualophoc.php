  ...
  <div class="container px-5 my-5">
    <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="./xulysualophoc.php" method="post">
        ...
        <div class="mb-3">
            ...
            <div class="invalid-feedback" data-sb-feedback="newField9:required">Tên lớp học không được để trống.</div>
        </div>
        <div class="mb-3">
            ...
            <div class="invalid-feedback" data-sb-feedback="newField12:required">Sĩ số không được để trống.</div>
        </div>
      
        <div class="d-grid">
            <button class="btn btn-primary" id="submitButton" type="submit" name="sualop">sửa</button>
        </div>
    </form>
</div>
  <!---end---->
