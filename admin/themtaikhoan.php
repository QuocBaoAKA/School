...
<form action="./xlthemtaikhoan.php" method="post">
  ...
  <div class="form_hs">
    ...
    <input type="text" class="input_hs" name="txt_mtk">
  </div>
  <div class="form_hs">
    <label>Tên tên tài khoản</label>
    <input type="text" class="input_hs"  name="txt_ttk">
  </div>
  <div class="form_hs">
    <label>Tên quyền</label>
    <input type="text" class="input_hs"  name="txt_tq">
  </div>
  <div class="form_hs">
    <label>Mật khẩu</label>
    <input type="text" class="input_hs" name="txt_mk">
  </div>
  <div class="form_hs">
    <label>Địa chỉ</label>
